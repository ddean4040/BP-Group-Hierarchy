	...
	<div id="content">
		...
		<form action="" method="post" id="groups-directory-form" class="dir-form">
			...
			<div class="item-list-tabs">
				<ul>
					<li class="selected" id="tree-all"><a href="<?php echo bp_get_root_domain() . '/' . BP_GROUPS_SLUG ?>"><?php global $bp; echo $bp->group_hierarchy->extension_settings['group_tree_name']; ?></a></li>
